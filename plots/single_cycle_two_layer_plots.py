...
#
# axs[0].plot(x, uCCA, label=r"$\frac{dAP_{ss}}{dS}\frac{1}{2}$", c="green", linestyle="dashed")
# axs[0].plot(x, CCA, label=r"$\frac{dAP_{ss}}{dS}\frac{S}{AP_{ss}}$", c="green", linestyle="dotted")
#
# # axs[1].plot(k1s, uCCB, label="BP CC/20", c="red", linestyle="dashed")
# # axs[1].plot(k1s, CCB, label="BP scaled CC/4", c="red", linestyle="dotted")
#
# axs[1].plot(x, uCCB, label=r"$\frac{dBP_{ss}}{dS}\frac{1}{10}$", c="red", linestyle="dashed")
# axs[1].plot(x, CCB, label=r"$\frac{dBP_{ss}}{dS}\frac{S}{BP_{ss}}\frac{1}{2}$", c="red", linestyle="dotted")
#
...
for i in np.arange(1, 1.8, .001):
    ...
    print(r1.getEE('J1', 'A'), r1.getEE('J2', 'AP'), r1.getEE('J3', 'B'), r1.getEE('J4', 'BP'))
    # print(i, r1.S, zeta)
#     a0 = 1/omega_n**2
#     a1 = (r1.getEE('J1', 'A') + r1.getEE('J2', 'AP') + r1.getEE('J3', 'B') + r1.getEE('J4', 'BP'))/(omega_n**2)
#     a2 = 1
#     a3 = 0
#     # if zeta == 1:
#     #     print()
#     # print(i, a0, a1, (a1*a2-a0*a3)/a1)
#     roo = -4/((r1.getEE('J1', 'A') + r1.getEE('J2', 'AP'))*(r1.getEE('J3', 'B') + r1.getEE('J4', 'BP'))) \
#           + ((r1.getEE('J1', 'A') + r1.getEE('J2', 'AP') + r1.getEE('J3', 'B') + r1.getEE('J4', 'BP'))**2) \
#           / (r1.getEE('J1', 'A') + r1.getEE('J2', 'AP'))*(r1.getEE('J3', 'B') + r1.getEE('J4', 'BP'))
#     print(roo)
#
#
...
axs[0].plot(x, uCCA, label=r"$\frac{dAP_{ss}}{dS}\frac{1}{3}$", c="green", linestyle="dashed")
axs[0].plot(x, CCA, label=r"$\frac{dAP_{ss}}{dS}\frac{S}{AP_{ss}}$", c="green", linestyle="dotted")
...
axs[1].plot(x, uCCB, label=r"$\frac{dBP_{ss}}{dS}\frac{1}{10}$", c="red", linestyle="dashed")
axs[1].plot(x, CCB, label=r"$\frac{dBP_{ss}}{dS}\frac{S}{BP_{ss}}\frac{1}{4}$", c="red", linestyle="dotted")
...
for i in np.arange(1, 1.5, .001):
    ...
    results = fr.getSpeciesFrequencyResponse(0.001, 3, 100, 'S', 'BP')
    for each in results:
